...
class NotificationService : Service() {
    ...
    //In this tutorial, we will be using a one-way communication
    ...
    override fun onCreate() {
        ...
        //while on the other hand, 'Handler' enqueus the process to HandlerThread to be executed
    ...
    //Create the notifcation with all of its contents and configurtions all set up
